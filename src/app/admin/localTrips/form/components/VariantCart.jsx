...
function VariantCart({ item, idx }) {
    ...
    return (
        <div className='flex items-center justify-between bg-gray-50 p-3 sm:p-4 border border-gray-200 rounded-lg '        >
            ...
            <div className="flex gap-1 sm:gap-2 items-center ml-4">
                <div
                    title="Edit"
